...
console.log(arrayItems) //Eliminar luego
...
function botonCancelarListeners(){  //Tiene un bug, al presionar cancelar se sigue viendo lo editado, solucionar en algun momento jsjsj
